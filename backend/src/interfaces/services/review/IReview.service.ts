...
import { PendingReviewResponseDTO, RatingAggregateResult, ReviewResponseDTO, ReviewResponsePopulatedRevewableIdDTO, ReviewResponsePopulatedUserDTO } from '@/dtos/response/review/review.response.dto';
