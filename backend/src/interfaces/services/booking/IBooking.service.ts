...
export interface IBookingService {
  lockSessionSlots(lockSlotsData,timezone:string): Promise<string[]>;
  ...
  checkDuplicateBooking(userId: string, sessionId: string, bookingSlots: IBookedSlot[],timezone:string): Promise<string | null>;
