...
import { CURRENCY, DOC_VERIFY_STATUS, GENDER,GOVT_ID_TYPE, TRAINER_CATEGORY, TRAINER_STATUS } from '@/constants/enums';
...
const TrainerProfileSchema = new mongoose.Schema({
  ...
  certificationInfo: {
    ...
    status: { type: String, enum: Object.values(DOC_VERIFY_STATUS),default: DOC_VERIFY_STATUS.PENDING},
    verifiedAt: Date,
    rejectReason:String
  },
  // --- ID  & Verification ---
