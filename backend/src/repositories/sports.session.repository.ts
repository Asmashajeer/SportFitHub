...
export class SportsSessionRepository
  extends BaseRepository<ISportsSession>
  implements ISportsSessionRepository
{
  ...
  async findBysessionId(sessionId: string | Types.ObjectId) {
    ...
    const session = await this.model
      ...
      .populate('sportCategory', '_id sportName icon slug')
          .populate('trainerId','displayName profilePic coreDiscipline specialties experience languages averageRating ')
      .lean()
      .exec();
