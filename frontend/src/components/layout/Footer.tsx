const Footer = () => {
  return (
    <footer className="w-full bg-background border-t border-border my-40 py-10 transition-colors">
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10 mb-12">
          ...
          <div className="min-w-30">
            <h4 className="text-foreground font-bold uppercase tracking-widest text-[10px] mb-6">Quick Links</h4>
          ...
          <div className="min-w-30">
            <h4 className="text-foreground font-bold uppercase tracking-widest text-[10px] mb-6">Programs</h4>
            <ul className="space-y-3 text-muted-foreground text-sm">
          ...
          {/* Support */}
          <div className="min-w-30">
            <h4 className="text-foreground font-bold uppercase tracking-widest text-[10px] mb-6">Support</h4>
            <ul className="space-y-3 text-muted-foreground text-sm">
