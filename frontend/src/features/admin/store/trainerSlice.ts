...
import { DOC_VERIFY_STATUS,GOVT_ID_TYPE, TRAINER_STATUS, type GenderType, type TRAINER_CATEGORY } from "@/constants/constants";
...
export const createTrainerSlice:StateCreator<TrainerSlice>=(set=>({
    ...
    removeTrainerFromList:(trainerId)=>set(state=>({
