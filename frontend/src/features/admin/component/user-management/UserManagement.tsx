      ...
      <div className="px-10 py-5 mt-0 bg-card">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2  lg:grid-cols-4 gap-6  mt-10">
          <StatCard
            ...
            icon={Users}
            color={"text-primary"}
            borderColor={"border-r-blue-900 border-b-blue-900"}
          />
          ...
          <StatCard
            ...
            icon={Users}
            color={"text-primary"}
            borderColor={"border-r-green-800 border-b-green-800"}
          />
          <StatCard
            key={3}
            title={"Blocked Users"}
            ...
            icon={Users}
            color={"text-primary"}
            borderColor={"border-r-red-900 border-b-red-900"}
          />
        </div>
        {/* Search and filters */}
                  ...
                  <div className="relative">
                    <Select value={roleFilter} onValueChange={(value)=>setRoleFilter(value)}>
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value={ROLES.USER}>{ROLES.USER[0].toUpperCase()+ROLES.USER.slice(1)}</SelectItem>
                        <SelectItem value={ROLES.TRAINER}>{ROLES.TRAINER[0].toUpperCase()+ROLES.TRAINER.slice(1)}</SelectItem>
