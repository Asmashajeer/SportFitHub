...
import BasicInfoForm from "../component/BasicInfo";
import ProfessionalInfoForm from "../component/ProfessionalInfoForm";
import PersonalInfoForm from "../component/PersonalInfo";
import Rates_ScheduleForm from "../component/Rates_ScheduleForm";
        ...
        <div className="space-y-6">
          <div className="text-center mb-8">
            ...
            <p className="text-muted-foreground max-w-xl mx-auto">
              ...
              "Inspire. Train. Transform. Become a <span className="text=primary">SportFit</span>Hub Coach
            </p>
          </div>
          ...
          setPreviewUrl={setPreviewUrl} onNext={nextStep} />}
            ...
            {step === 5 && <FinancialInfoForm onBack={prevStep} isSubmitting={isSubmitting} />}
