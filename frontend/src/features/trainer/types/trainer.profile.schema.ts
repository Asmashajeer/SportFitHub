...
const  documents=z.object({
  ...
  path:['validUpto'],
}).refine((data) => data.issuedAt <= new Date(), {       //check for incorrect date
...
// export type  AddTrainerProfileData = Omit<z.infer<typeof AddTrainerProfileSchema>, 'profilePic'> & {
//   profilePic: FileList | null; // Form handles the raw FileList
// };