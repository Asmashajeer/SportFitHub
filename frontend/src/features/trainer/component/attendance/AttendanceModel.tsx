    ...
    return (
       <div className="fixed inset-0 bg-zinc-800/70 flex items-center justify-center z-1000"
            ...
            <div className=" bg-zinc-700 rounded-xl w-120 max-w-[92%] border-[0.5px] border-border overflow-hidden"
                ...
                data && (
                        <>
                            <div className="px-5 py-3 flex items-center justify-between border-b-[0.5px] border-border bg-(--surface-1)">
                            ...
                            <div
                                ...
                                className="flex items-center justify-between px-5 py-3 border-b-[0.5px] border-border"
                                >
